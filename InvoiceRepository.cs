...
namespace InvoiceManagementApi.Repositories
{
    public class InvoiceRepository : IInvoiceRepository
    {
        ...
        public async Task<string> InsertOrUpdateInvoiceAsync(Invoice invoice, int? createdBy = null)
        {
            ...
            parameters.Add("@WeightmentNo", invoice.WeightmentNo);
            parameters.Add("@CGSTPer", invoice.TotalCgst);
            parameters.Add("@SGSTPer", invoice.TotalSgst);
            parameters.Add("@GSTPer", invoice.TotalIgst);
